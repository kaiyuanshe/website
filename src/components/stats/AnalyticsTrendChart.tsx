    ...
    <div className={styles.chartContainer}>
      <div className={styles.chartHeader}>
        <h3 className={styles.chartTitle}>
          <LocalizedText>{"运营数据趋势"}</LocalizedText>
        </h3>

        <div className={styles.chartLegend}>
          {["页面浏览量", "用户数", "会话数"].map((label, index) => (
            <div key={label} className={styles.legendItem}>
              <div
                className={styles.legendColor}
                style={{
                  backgroundColor: ["#3b82f6", "#f59e0b", "#ef4444"][index],
                }}
              />
          ...
          >
            ...
            <div className={styles.tooltipContent}>
              <div className={styles.tooltipItem}>
                ...
                ></div>
                <span>
                  <LocalizedText>{"页面浏览量:"}</LocalizedText>
                  {tooltip.values.pageViews.toLocaleString()}
                </span>
              </div>
              <div className={styles.tooltipItem}>
                <div
                ...
                ></div>
                <span>
                  <LocalizedText>{"用户数:"}</LocalizedText>
                  {tooltip.values.users.toLocaleString()}
                </span>
              </div>
              <div className={styles.tooltipItem}>
                <div
                ...
                ></div>
                <span>
                  <LocalizedText>{"会话数:"}</LocalizedText>
                  {tooltip.values.sessions.toLocaleString()}
                </span>
              </div>
            </div>
          </div>
