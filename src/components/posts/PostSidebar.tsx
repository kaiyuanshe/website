    ...
    <div className={styles.sidebar}>
      ...
      <Card className={styles.sidebarCard}>
        <div className={styles.sidebarHeader}>
          ...
          <h3 className={styles.sidebarTitle}>
            <LocalizedText>{"热门帖子"}</LocalizedText>
          </h3>
        </div>
        <div className={styles.hotPosts}>
          ...
          {(postsStats?.weekly_hot_posts?.length ?? 0) === 0 && (
            <Empty description={translateUiText("暂无热门帖子")} />
          )}
        </div>
      </Card>
      ...
      <Card className={styles.sidebarCard}>
        <div className={styles.sidebarHeader}>
          ...
          <h3 className={styles.sidebarTitle}>
            <LocalizedText>{"活跃作者"}</LocalizedText>
          </h3>
        </div>
        <div className={styles.activeUsers}>
              ...
              >
                ...
                <div className={styles.activeUserInfo}>
                  ...
                  <div className={styles.activeUserPosts}>
                    <LocalizedText>{"帖子数:"}</LocalizedText>
                    {user.post_count || 0}
                  </div>
                </div>
              </Link>
          ...
          {(postsStats?.top_active_users?.length ?? 0) === 0 && (
            <Empty description={translateUiText("暂无活跃用户")} />
          )}
        </div>
      </Card>
      ...
      <Card className={styles.sidebarCard}>
        <div className={styles.sidebarHeader}>
          ...
          <h3 className={styles.sidebarTitle}>
            <LocalizedText>{"社区统计"}</LocalizedText>
          </h3>
        </div>
        <div className={styles.communityStats}>
          <div className={styles.statItem}>
            ...
            <div className={styles.statLabel}>
              <LocalizedText>{"总帖子数"}</LocalizedText>
            </div>
          </div>
          <div className={styles.statItem}>
            <div className={styles.statNumber}>
            ...
            <div className={styles.statLabel}>
              <LocalizedText>{"活跃用户"}</LocalizedText>
            </div>
          </div>
          <div className={styles.statItem}>
            <div className={styles.statNumber}>
            ...
            <div className={styles.statLabel}>
              <LocalizedText>{"本周帖子"}</LocalizedText>
            </div>
          </div>
        </div>
      </Card>
