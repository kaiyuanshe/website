  ...
  if (!loading && !article) {
    return (
      <div className={styles.error}>
        <h2>
          <LocalizedText>{"博客不存在"}</LocalizedText>
        </h2>
        <p>
          <LocalizedText>{"抱歉，找不到您要查看的博客"}</LocalizedText>
        </p>
        <Link href="/blogs" className={styles.backButton}>
          <LocalizedText>{"返回博客列表"}</LocalizedText>
        </Link>
      </div>
    );
  }
        ...
        <div className={styles.formGrid}>
          ...
          <div className={styles.leftColumn}>
            ...
            <Card className={styles.section}>
              ...
              <Form.Item
                label={translateUiText("博客标题")}
                name="title"
                rules={[{ required: true, message: "请输入博客标题" }]}
              >
                <Input
                  placeholder={translateUiText("请输入博客标题")}
              ...
              >
                <TextArea
                  ...
                  maxLength={60}
                  showCount
                  placeholder={translateUiText("请输入博客描述")}
                />
              </Form.Item>
              <Form.Item
                label={translateUiText("博客内容")}
                name="content"
          ...
          <div className={styles.rightColumn}>
            ...
            <Card className={styles.section}>
              <h2 className={styles.sectionTitle}>
                ...
                <LocalizedText>{"博客封面"}</LocalizedText>
              </h2>
              <Form.Item
                name="cover"
            ...
            <Card className={styles.section}>
              <h2 className={styles.sectionTitle}>
                ...
                <LocalizedText>{"博客标签"}</LocalizedText>
              </h2>
