...
import { heroImages, timelineData, honorsData } from "@/data/about";
  ...
  useEffect(() => {
    const handleResize = () => {
      const newItemsToShow =
        window.innerWidth <= 768 ? 2 : window.innerWidth <= 1024 ? 3 : 5;
      ...
      <div className={styles.heroSection}>
        ...
        <div className={styles.heroOverlay}>
          <h1 className={styles.heroTitle}>
            <LocalizedText>{"你好， 开源社"}</LocalizedText>
          </h1>
        ...
        <main className={styles.contentArea}>
          ...
          <section className={styles.section}>
            <h2 className={styles.sectionTitle}>
              <LocalizedText>{"一、我们从何而来"}</LocalizedText>
            </h2>
            ...
            <div className={styles.imageContainer}>
              <img
                ...
                alt={translateUiText("开源社四大使命")}
                className={styles.contentImage}
              />
              <p className={styles.imageCaption}>
                <LocalizedText>{"开源社四大使命"}</LocalizedText>
              </p>
            </div>
          ...
          <section className={styles.section}>
            <h2 className={styles.sectionTitle}>
              <LocalizedText>{"二、我们在做什么"}</LocalizedText>
            </h2>

            <div className={styles.imageContainer}>
              <img
                src="/img/about/how.webp"
                alt={translateUiText("开源社的工作")}
                className={styles.contentImage}
              />
              <p className={styles.imageCaption}>
                <LocalizedText>{"开源社的工作"}</LocalizedText>
              </p>
            </div>

            <h3 className={styles.subsectionTitle}>
              <LocalizedText>{"开源治理"}</LocalizedText>
            </h3>
            <p className={styles.text}>
              <LocalizedText>
                {
            ...
            <div className={styles.imageContainer}>
              <img
                src="/img/about/2024.webp"
                alt={translateUiText("开源治理")}
                className={styles.contentImage}
              />
            </div>

            <h3 className={styles.subsectionTitle}>
              <LocalizedText>{"国际/跨境接轨"}</LocalizedText>
            </h3>
            <p className={styles.text}>
              <LocalizedText>
                {
            ...
            <div className={styles.imageContainer}>
              <img
                ...
                alt="Stefano Maffulli with Board Directors"
                className={styles.contentImage}
              />
              <p className={styles.imageCaption}>
                Stefano Maffulli with Board Directors of KAIYUANSHE: Emily Chen,
                Nadia Jiang (photo credits), and Ted Liu.
              </p>
            </div>

            <h3 className={styles.subsectionTitle}>
              <LocalizedText>{"社区发展"}</LocalizedText>
            </h3>
            <p className={styles.text}>
              <LocalizedText>
                {
            ...
            <div className={styles.imageContainer}>
              <img
                src="/img/about/exhibition1.webp"
                alt={translateUiText("2021-2024年中国开源年会")}
                className={styles.contentImage}
              />

              <img
                src="/img/about/exhibition2.webp"
                className={styles.contentImage}
              />

              <p className={styles.imageCaption}>
                <LocalizedText>{"2021-2024年中国开源年会"}</LocalizedText>
              </p>
            </div>
            ...
            <div className={styles.imageGrid}>
              <img
                ...
                onClick={() =>
                  openModal("/img/about/coscon-1.webp", "COSCon 合影")
                }
                alt={translateUiText("COSCon 合影")}
              />
              ...
              <img
                ...
                className={styles.gridImage}
                onClick={() =>
                  openModal("/img/about/coscon-2.webp", "COSCon 合影")
                }
                alt={translateUiText("COSCon 合影")}
              />
              ...
              <img
                ...
                className={styles.gridImage}
                onClick={() =>
                  openModal("/img/about/coscon-3.webp", "COSCon 合影")
                }
                alt={translateUiText("COSCon 合影")}
              />
              ...
              <img
                ...
                className={styles.gridImage}
                onClick={() =>
                  openModal("/img/about/coscon-4.webp", "COSCon 合影")
                }
                alt={translateUiText("COSCon 合影")}
              />
            </div>
            <p className={styles.imageCaption}>
              <LocalizedText>{"COSCon 合影"}</LocalizedText>
            </p>
            ...
            <div className={styles.imageGrid}>
              <img
                ...
                alt={translateUiText("社区合作活动")}
                className={styles.gridImage}
                onClick={() =>
                  openModal("/img/about/community-1.webp", "社区合作活动")
                }
              />
              ...
              <img
                ...
                className={styles.gridImage}
                onClick={() =>
                  openModal("/img/about/community-2.webp", "社区合作活动")
                }
              />
              ...
              <img
                ...
                className={styles.gridImage}
                onClick={() =>
                  openModal("/img/about/community-3.webp", "社区合作活动")
                }
              />
              ...
              <img
                ...
                className={styles.gridImage}
                onClick={() =>
                  openModal("/img/about/community-4.webp", "社区合作活动")
                }
              />
              ...
              <img
                ...
                className={styles.gridImage}
                onClick={() =>
                  openModal("/img/about/community-5.webp", "社区合作活动")
                }
              />
              ...
              <img
                ...
                className={styles.gridImage}
                onClick={() =>
                  openModal("/img/about/community-6.webp", "社区合作活动")
                }
              />
            </div>
            <p className={styles.imageCaption}>
              <LocalizedText>{"社区合作活动合影"}</LocalizedText>
            </p>

            <h3 className={styles.subsectionTitle}>
              <LocalizedText>{"中国开源年度报告"}</LocalizedText>
            </h3>
            <p className={styles.text}>
              <LocalizedText>
                {
            ...
            <ul className={styles.list}>
              <li>
                <LocalizedText>{"2015 年："}</LocalizedText>
                <a
                  href="https://kaiyuanshe.github.io/document/china-os-report-2015"
                  target="_blank"
              ...
              <li>
                <LocalizedText>{"2016 年："}</LocalizedText>
                <a
                  href="https://github.com/kaiyuanshe/2016-China-Open-Source-Report"
                  target="_blank"
                  rel="noopener noreferrer"
                >
              ...
              <li>
                <LocalizedText>{"2018 年："}</LocalizedText>
                <a
                  href="https://kaiyuanshe.github.io/2018-China-Open-Source-Report"
                  target="_blank"
                  rel="noopener noreferrer"
                >
              ...
              <li>
                <LocalizedText>{"2019 年："}</LocalizedText>
                <a
                  href="https://kaiyuanshe.github.io/2019-China-Open-Source-Report"
                  target="_blank"
                  rel="noopener noreferrer"
                >
              ...
              <li>
                <LocalizedText>{"2020 年："}</LocalizedText>
                <a
                  href="https://kaiyuanshe.github.io/document/china-os-report-2020"
                  target="_blank"
                  rel="noopener noreferrer"
                >
              ...
              <li>
                <LocalizedText>{"2021 年："}</LocalizedText>
                <a
                  href="https://kaiyuanshe.github.io/document/china-os-report-2020"
                  target="_blank"
                  rel="noopener noreferrer"
              ...
              <li>
                <LocalizedText>{"2022 年："}</LocalizedText>
                <a
                  href="https://kaiyuanshe.feishu.cn/wiki/wikcnnJ8b90pOoDRFzXngfRslkd"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  https://kaiyuanshe.feishu.cn/wiki/wikcnnJ8b90pOoDRFzXngfRslkd
                </a>
              </li>
              <li>
                <LocalizedText>{"2023 年："}</LocalizedText>
                <a
                  href="https://kaiyuanshe.github.io/2023-China-Open-Source-Report"
                  target="_blank"
                  rel="noopener noreferrer"
                >
              ...
              <li>
                <LocalizedText>{"2024 年："}</LocalizedText>
                <a
                  href="https://kaiyuanshe.github.io/2024-China-Open-Source-Report"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  https://kaiyuanshe.github.io/2024-China-Open-Source-Report
                </a>
              </li>
            </ul>
            ...
            <div className={styles.imageContainer}>
              <img
                src="/img/about/kaiyuan.webp"
                alt={translateUiText("历届中国开源年度报告")}
                className={styles.contentImage}
              />
              <p className={styles.imageCaption}>
                <LocalizedText>{"历届中国开源年度报告"}</LocalizedText>
              </p>
            </div>

            <h3 className={styles.subsectionTitle}>
              <LocalizedText>{"开源项目"}</LocalizedText>
            </h3>
            <p className={styles.text}>
              <LocalizedText>
                {
            ...
            <h3 className={styles.subsectionTitle}>
              <LocalizedText>{"开源教育"}</LocalizedText>
            </h3>
            <p className={styles.text}>
              <LocalizedText>
                {
          ...
          <section className={styles.section}>
            <h2 className={styles.sectionTitle}>
              <LocalizedText>{"三、我们如何运作"}</LocalizedText>
            </h2>
            <p className={styles.text}>
              <LocalizedText>
                {
            ...
            <div className={styles.imageContainer}>
              <img
                src="/img/about/operation1.webp"
                alt={translateUiText("开源社组织架构（2025）")}
                className={styles.contentImage}
              />
              <p className={styles.imageCaption}>
                <LocalizedText>{"开源社组织架构（2025）"}</LocalizedText>
              </p>
            </div>

            <div className={styles.imageContainer}>
              <img
                src="/img/about/lishi.webp"
                alt={translateUiText("开源社 2025 届理事会")}
                className={styles.contentImage}
              />
              <p className={styles.imageCaption}>
                <LocalizedText>{"开源社 2025 届理事会"}</LocalizedText>
              </p>
            </div>
          ...
          <section className={styles.section}>
            <h2 className={styles.sectionTitle}>
              <LocalizedText>{"四、联系我们"}</LocalizedText>
            </h2>
            <ul className={styles.contactList}>
              ...
              <li>
                <LocalizedText>{"社交媒体账号："}</LocalizedText>
                <ul className={styles.subList}>
                  <li>
                    <LocalizedText>{"公众号：开源社KAIYYUANSHE"}</LocalizedText>
                  </li>
                  <li>
                    <LocalizedText>
                      {"X（Twitter）：@开源社KAIYUANSHE"}
                    </LocalizedText>
                  </li>
                  <li>
                    <LocalizedText>{"LinkedIn：@kaiyuanshe"}</LocalizedText>
                  </li>
                </ul>
              </li>
              <li>
                <LocalizedText>
                  {"联系邮箱：contact@kaiyuanshe.org"}
                </LocalizedText>
              </li>
            </ul>
            ...
            <div className={styles.highlightBox}>
              <h3>
                <LocalizedText>{"近期重要活动："}</LocalizedText>
              </h3>
              <p>
                <LocalizedText>
                  {"12月6至7日将举办第十届中国开源年会（COSCon'25）"}
                </LocalizedText>
              </p>
              <p>
                <LocalizedText>
                  {
                    "Open Source, Open Intelligence｜第十届中国开源年会议题征集正式启动！"
                  }
                </LocalizedText>
              </p>
            </div>
          ...
          <section className={styles.section}>
            <h2 className={styles.sectionTitleCentered}>
              <LocalizedText>{"发展历程"}</LocalizedText>
            </h2>
          ...
          <section className={styles.section}>
            <h2 className={styles.sectionTitleCentered}>
              <LocalizedText>{"荣誉墙"}</LocalizedText>
            </h2>
            <p className={styles.description}>
              <LocalizedText>
                {
            ...
            <div className={styles.honorCarousel}>
                  ...
                  {honorsData.map((honor, index) => (
                    <div key={index} className={styles.honorCard}>
                      ...
                      <div className={styles.honorContent}>
                        <h4 className={styles.honorTitle}>
                          {translateText(honor.title)}
                        </h4>
                        <div className={styles.honorDate}>
                          {translateText(honor.date)}
                        </div>
                        <p className={styles.honorDescription}>
                          {translateText(honor.description)}
                        </p>
                      </div>
                    </div>
                  ))}
              ...
              <div className={styles.honorIndicators}>
                {Array.from({
                  length: Math.max(1, honorsData.length - itemsToShow + 1),
                }).map((_, index) => (
                  <button
                    key={index}
                    ...
                    aria-label={translateUiText(`跳转到第${index + 1}组`)}
                  />
                ))}
              </div>
            </div>
          ...
          <section className={styles.section}>
            <h2 className={styles.sectionTitle}>
              <LocalizedText>{"鸣谢"}</LocalizedText>
            </h2>
            <p className={styles.text}>
              <LocalizedText>
            ...
            <div className={styles.imageContainer}>
              <img
                src="/img/about/thanks1.webp"
                alt={translateUiText("合作伙伴")}
                className={styles.contentImage}
              />
            </div>
          </section>
