    ...
    <div className={styles.loginPage}>
      <div className={styles.container}>
        <h2 className={styles.title}>
          {isRegister
            ? translateUiText("欢迎注册")
            : translateUiText("欢迎登录")}
        </h2>
        ...
        {isRegister ? (
          <Form layout="vertical" onFinish={onRegisterFinish}>
            ...
            >
              <Input placeholder={translateUiText("邮箱")} />
            </Form.Item>
            ...
            >
              <Input placeholder={translateUiText("用户名")} />
            </Form.Item>
            ...
            >
              <Input.Password placeholder={translateUiText("密码")} />
            </Form.Item>
            ...
            >
              <Input.Password placeholder={translateUiText("确认密码")} />
            </Form.Item>
            ...
            <Form.Item style={{ marginBottom: "8px" }}>
              <div style={{ display: "flex", gap: "8px" }}>
                ...
                >
                  <Input placeholder={translateUiText("验证码")} />
                </Form.Item>
                <Captcha
                  ref={captchaRef}
            ...
            <Form.Item>
              ...
              >
                <LocalizedText>{"立即注册"}</LocalizedText>
              </Button>
            </Form.Item>
        ...
        <div className={styles.link}>
          {isRegister
            ? translateUiText("已有账号？")
            : translateUiText("还没有账号？")}
          <a
            onClick={() => {
          ...
          >
            {isRegister
              ? translateUiText("立即登录")
              : translateUiText("立即注册")}
          </a>
        </div>
      </div>
      ...
      <Modal
        ...
        okText={translateUiText("去登录")}
        cancelText={translateUiText("关闭")}
      >
        <p>
          <LocalizedText>{"恭喜您注册成功！"}</LocalizedText>
        </p>
        <p>
          <LocalizedText>
            {"请前往您的邮箱查看激活邮件，点击邮件中的链接激活您的账户。"}
          </LocalizedText>
        </p>
        <p>
          <LocalizedText>{"激活后即可正常登录使用。"}</LocalizedText>
        </p>
      </Modal>
    </div>
  );
