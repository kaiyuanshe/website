    ...
    <div className={`${styles.container} nav-t-top`}>
      ...
      <div className={styles.titleSection}>
        <h1 className={styles.title}>
          <LocalizedText>{"新建活动"}</LocalizedText>
        </h1>
      </div>
                  ...
                  >
                    <Select
                      ...
                      options={[
                        ...
                        { label: translateUiText("跳转到百格网站"), value: 2 },
                      ]}
