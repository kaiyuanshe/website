    ...
    <div className={styles.container}>
      <div className={styles.header}>
        <h1 className={styles.title}>
          <LocalizedText>{"中国开源先锋榜"}</LocalizedText>
        </h1>
        <div className={styles.sponsor}>
          <span className={styles.sponsorText}>
            <LocalizedText>{"发起单位"}</LocalizedText>
          </span>
          <div className={styles.sponsorLogos}>
            <img
              src="/logo_2.svg"
              alt={translateUiText("开源社发起单位Logo")}
              className={styles.sponsorLogo}
            />
            <img
              src="/img/media/segmentfault.png"
              alt={translateUiText("思否发起单位Logo")}
              className={styles.sponsorLogo}
            />
          </div>
        </div>
        <p className={styles.subtitle}>
          ...
          <LocalizedText>
            {
              "这不是一个千篇一律的人物排行，而是——面向开发者的“米其林推荐”、“心（舌）尖上的开源人物”。"
            }
          </LocalizedText>
          <br />
          <LocalizedText>
            {
              "榜单发布时除发布名单,每位人物还都会配有推介理由,它既是对于过去一年的总结也是由 SegmentFault 思否和开源社为你联合推介的“年度最值得关注的开源人物”。"
            }
          </LocalizedText>
        </p>
      </div>
        ...
        <div key={year} className={styles.yearSection}>
          <div className={styles.yearHeader}>
            <h2 className={styles.yearTitle}>
              {year}
              <LocalizedText>{"年开源先锋"}</LocalizedText>
            </h2>
            ...
            {pioneersByYear[year].map((pioneer) => (
              ...
              >
                ...
                <div className={styles.pioneerInfo}>
                  ...
                  <p className={styles.pioneerTitle}>
                    {translateText(pioneer.title)}
                  </p>
                </div>
              </div>
            ))}
          ...
          <div className={styles.modal} onClick={(e) => e.stopPropagation()}>
            <div className={styles.modalHeader}>
              <h2 className={styles.modalTitle}>
                <LocalizedText>{"开源先锋详情"}</LocalizedText>
              </h2>
              <button
                className={styles.closeButton}
                onClick={handleCloseModal}
                aria-label={translateUiText("关闭")}
              >
                ×
              </button>
            </div>
            ...
            <div className={styles.modalContent}>
              ...
              <div className={styles.modalInfo}>
                ...
                <p className={styles.modalJobTitle}>
                  {translateText(selectedPioneer.title)}
                </p>

                <div className={styles.modalDescription}>
                  <h4>
                    <LocalizedText>{"推荐理由"}</LocalizedText>
                  </h4>
                  <p>{translateText(selectedPioneer.description)}</p>
                </div>
              </div>
            </div>
          </div>
