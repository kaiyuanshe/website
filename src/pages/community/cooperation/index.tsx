...
const cooperationStars2021 = [
  {
    ...
    nickname: '',
    avatar: '/img/cblecker.png',
    recommendation: '何(小)莹身为开源社社区合作组副组长，几年以来持续地投入社区合作，今年完美地组织以及主持了 “暑期2021之大咖说开源“，之后紧张地准备出国留学的同时，还积极地与开源社社区合作组小伙伴们推动 COSCon21 社区合作事宜，让 COSCon21的合作社区达到了创记录的 75 家以上，出国当天和到达留学地之后，仍不间断地联系社区合作伙伴们，坚持不懈的精神令人感动。我们亲昵地叫她 “流浪的开源小可爱“，因为她就是当仁不让的 “社区合作之星”。初次见面是何莹来给年会开源硬件论坛做翻译志愿者，之后便常常在开源社的各个社群都能看到她活跃的身影，为开源社的社区活跃和合作做了大量的贡献，她的热情的态度和细腻的笔触令开源社区增添了柔性的温度。初次见面是何莹来给年会开源硬件论坛做翻译志愿者，之后便常常在开源社的各个社群都能看到她活跃的身影，为开源社的社区活跃和合作做了大量的贡献，她的热情的态度和细腻的笔触令开源社区增添了柔性的温度。'
  },
  {
    name: '范晶晶',
    nickname: '',
