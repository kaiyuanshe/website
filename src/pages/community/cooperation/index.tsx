...
const cooperationStars2021 = [
  {
    ...
    nickname: '',
    avatar: '/img/cblecker.png',
    recommendation: '何(小)莹身为开源社社区合作组副组长，几年以来持续地投入社区合作，今年完美地组织以及主持了 “暑期2021 之大咖说开源“，之后紧张地准备出国留学的同时，还积极地与开源社社区合作组小伙伴们推动 COSCon'21 社区合作事宜，让 COSCon'21 的合作社区达到了创记录的 75 家以上，出国当天和到达留学地之后，仍不间断地联系社区合作伙伴们，坚持不懈的精神令人感动。我们亲昵地叫她 “流浪的开源小可爱“，因为她就是当仁不让的 “社区合作之星”。初次见面是何莹来给年会开源硬件论坛做翻译志愿者，之后便常常在开源社的各个社群都能看到她活跃的身影，为开源社的社区活跃和合作做了大量的贡献，她的热情的态度和细腻的笔触令开源社区增添了柔性的温度。初次见面是何莹来给年会开源硬件论坛做翻译志愿者，之后便常常在开源社的各个社群都能看到她活跃的身影，为开源社的社区活跃和合作做了大量的贡献，她的热情的态度和细腻的笔触令开源社区增添了柔性的温度。'
  },
  {
    name: '范晶晶',
    nickname: '',
  ...
  },
  {
    ...
    nickname: '小明',
    avatar: '/img/cblecker.png',
    recommendation: '开源社媒体组负责 “人找事、事找人“ 板块的李明康堪称万能，需要他的时候，他随时可以钻进电话亭变身超人来救人救火。这次 COSCon'21 千头万绪，但是李明康在组委会，在媒体组宣发，在社区合作，常常第一个在各个群里推送大会相关宣传文章的就是他。明康，我们都有看到你哦!对于明康是从耳闻到目睹，明康本身也是从媒体志愿逐步积极拓展到开源社多项事务的志愿，充分展现了一个开源社区志愿者的能动性和多面工作实践的潜力。小明是开源社媒体组的长期贡献志愿者，还是媒体组为数不多有技术背景的志愿者。他非常积极努力，不用我们多说，他都会冲在最前面。这次在年会中（以及之前），他真正实现了出圈，从媒体组走出去在社区合作组，组委会，项目组里面异常活跃，大家都知道了我们媒体组的宝藏男孩小明同学！'
  },
  {
    name: '李楠',
    nickname: '楠楠',
