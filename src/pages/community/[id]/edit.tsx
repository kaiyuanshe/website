    ...
    try {
      ...
      if (result.success && result.data) {
        ...
        form.setFieldsValue({
          ...
          translationOf: community.translation_of,
        });
  ...
  if (isLoadingDetail) {
    return (
      ...
      >
        <Spin size="large" />
        <p style={{ marginTop: "16px" }}>
          <LocalizedText>{"正在加载社区数据..."}</LocalizedText>
        </p>
      </div>
    );
  }
    ...
    <div className={styles.container}>
      <div className={styles.header}>
        <h1 className={styles.title}>
          <LocalizedText>{"编辑城市社区"}</LocalizedText>
        </h1>
        <p className={styles.subtitle}>
          <LocalizedText>{"编辑开源社城市社区信息"}</LocalizedText>
        </p>
      </div>
        ...
        >
          ...
          <Form.Item className={styles.actions}>
            ...
            <Button
              ...
              disabled={isSubmitting}
            >
              <LocalizedText>{"更新社区"}</LocalizedText>
            </Button>
          </Form.Item>
        </Form>
      </Card>
