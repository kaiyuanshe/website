...
export const partnersRawData: Partner[] = [
  ...
  {
    "title": "2019 铜牌赞助 NebulaGraph Community",
...
export const organizePartnersByLevel = (data: Partner[]): { [level: string]: Partner[] } => {
