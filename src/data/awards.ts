...
export const openSourceStars: AwardRecipient[] = [
  ...
  },
  {
    ...
    avatar: '/img/cblecker.png',
    date: 2021,
    recommendation: '幕后英雄，贡献卓越。郭浩赟积极参与开源社多个项目与活动，担任开源社 KToken 项目组组长，并主持 KToken 新版本重构；开放黑客松项目组成员，举办 COSCon'20 以太坊黑客松活动；担任 COSCon'21 开源百宝箱分论坛出品人。作为以太坊亚太社区 ETHPlanet 负责人，浩赟主动地推动 ETHPlanet 成为开源社 2021 年度赞助伙伴。多才多能，热心公益，贡献开源，获选 “开源之星“ 实至名归。从第一次参与年会工作，郭浩赟就为多个论坛主题贡献邀请了V神等在内的讲师嘉宾，并且从开源社区角度严格把控了所负责的区块链论坛的演讲质量，后面在开源社的多个工作组也是一直长期贡献，期待在开源社将来和区块链结合的深度发展方面，能看到带来更多的花火。热心开源的帅小伙儿！开源社各个工作组都看得到浩赟的身影，在他的努力下，KToken项目渐有起色，开放黑客松更有创意，开源年会区块链相关的主题质量也越来越高。很厉害！'
  },
  {
    name: '许银',
    nickname: '',
...
export const cosconStars2022: AwardRecipient[] = [
  ...
  },
  {
    ...
    nickname: '',
    avatar: '/img/cblecker.png',
    recommendation: '连续3年的COSCon志愿者，能力优秀，态度认真！同时也是KToken项目的成员之一，今年作为主要Owner推进COSCon数字徽章的工作，使得COSCon'22数字徽章跟大家见面！'
  },
  {
    name: '李明康',
    nickname: '',
